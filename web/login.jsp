                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="site_logo fix">
                            <a id="brand" class="clearfix navbar-brand border-right-whitesmoke" href="index.jsp"><img
...
<div style="margin: auto;
  ...
  padding-bottom: 3rem !important;">
    ...
    <div style="register-w3;">
        <div style="width: 100%; padding-right: 15px; padding-left: 15px;margin-right: auto;  margin-left: auto; padding-top: 3rem !important;padding-bottom: 1rem !important;">
                    ...
                    <form action="login" method="post">
                        <div class="row">
                            ...
                            <div style="-webkit-box-flex: 0;-ms-flex: 0 0 90%;  flex: 0 0 50%; max-width: 80%;"
                                ...
                                <input class="form-control" type="email" id="email" name="email" placeholder="Type Here.."
                                       required="">
                            </div>
                        ...
                        <button type="submit"
                                style="text-center;margin-top: 1rem !important;margin: auto; width: 20%;padding-right:0px; -webkit-appearance: button ;">
                            Login
                        </button>
