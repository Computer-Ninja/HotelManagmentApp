                        ...
                        <form action="LoginServlet" method="post">
                            <div class="row">
                                ...
                                <div style="-webkit-box-flex: 0;-ms-flex: 0 0 90%;  flex: 0 0 50%; max-width: 80%;" class="form-group;">
                                    ...
                                    <input class="form-control" type="text" name="username" placeholder="Type Here.." required="">
                                </div>
                            ...
                            <button type="submit" style="text-center;margin-top: 1rem !important;margin: auto; width: 20%;padding-right:0px; -webkit-appearance: button ;">Login</button>
