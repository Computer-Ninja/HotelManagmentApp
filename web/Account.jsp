								...
								<div class="hotel_stuff">
											...
											<div
												...
												<div style="comment-top margin-top: 3rem !important;">
													<div class="comment-bottom mobamuinfo_mail_grid_right">
															...
															<div class="row">
																<div
																	...
																	<label>Phone Number</label> <input class="form-control"
																		type="number" name="phone" placeholder="0773331258"
																		required="">
																</div>
															</div>
															...
															<div class="row">
																<div
																	...
																	<label>Email</label> <input class="form-control"
																		type="email" name="email" placeholder="hiru@gmail.com"
																		required="">
																</div>
															</div>
														...
														<p><a href="profile.jsp"><u>Need to Change Password</u></a></p></font>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div
											...
											<div
												class="section_title margin-bottom-35 padding-bottom-25 border-bottom-whitesmoke">
												<h5>History</h5>
											</div>
